...
use app\models\search\PersonalSearch;
...
class PersonalController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['index', 'id_personal' => $model->id_personal]);
            }
        } else {
    ...
    {
        if (($model = Personal::findOne(['id_personal' => $id])) !== null) {
            return $model;
        }
